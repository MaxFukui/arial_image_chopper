...
shapefiles = {label: main_path.format(file_name=name) for label, name in config['shapefiles'].items()}
...
save_color_mapped_mask(output_mask_path, color_mask_path, class_labels, colormap)
...
tile_raster_images(image_fp, output_mask_path, tile_size, OUTPUT_DIR, colormap)
